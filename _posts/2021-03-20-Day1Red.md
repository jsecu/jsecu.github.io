...
In this technique we are abusing the implementation of process fibers in order to run local shellcode. 
...
This will cause a alert due to this being a meterpreter payload for spawning calc.exe*
